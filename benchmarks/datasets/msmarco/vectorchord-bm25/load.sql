...
$$);
UPDATE msmarco_passages SET embedding = tokenize(passage, 'bert');
CREATE INDEX msmarco_vectorchord_idx ON documents
...
SELECT
    'INDEX_SIZE:' as label,
    pg_size_pretty(pg_relation_size('msmarco_vectorchord_idx')) as index_size,
    pg_relation_size('msmarco_vectorchord_idx') as index_bytes;
SELECT
    'TABLE_SIZE:' as label,
